...
#ifndef RTW_HEADER_shaping_private_h_
#define RTW_HEADER_shaping_private_h_
#include "rtwtypes.h"
...
extern void shaping_derivatives(void);

#endif                                 /* RTW_HEADER_shaping_private_h_ */

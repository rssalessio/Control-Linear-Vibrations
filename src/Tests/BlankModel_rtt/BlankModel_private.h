...
#ifndef RTW_HEADER_BlankModel_private_h_
#define RTW_HEADER_BlankModel_private_h_
#include "rtwtypes.h"
...
extern void BlankModel_derivatives(void);

#endif                                 /* RTW_HEADER_BlankModel_private_h_ */

...
#ifndef RTW_HEADER_porcoilclero_private_h_
#define RTW_HEADER_porcoilclero_private_h_
#include "rtwtypes.h"
...
extern void porcoilclero_derivatives(void);

#endif                                 /* RTW_HEADER_porcoilclero_private_h_ */

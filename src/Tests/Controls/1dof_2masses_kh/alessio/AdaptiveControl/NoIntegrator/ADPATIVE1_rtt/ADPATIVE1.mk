...
# Autogenerated on: 06-May-2016 10:33:25
# Model: ADPATIVE1
# MyTemplate
# File name: ADPATIVE1.mk
# Template: gmake 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/include" -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"C:/Users/user/Documents/GitHub/linearVibrationsControl/src/Tests/Controls/1dof_2masses_kh/alessio/AdaptiveControl/NoIntegrator/ADPATIVE1_rtt" -I"C:/Users/user/Documents/GitHub/linearVibrationsControl/src/Tests/Controls/1dof_2masses_kh/alessio/AdaptiveControl/NoIntegrator" -I"D:/Matlab/extern/include" -I"D:/Matlab/simulink/include" -I"D:/Matlab/rtw/c/src" -I"D:/Matlab/rtw/c/src/ext_mode/common" -I"D:/Matlab/rtw/c/ert" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/system/libsam" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/system/CMSIS/CMSIS/Include" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/system/CMSIS/Device/ATMEL" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/cores/arduino" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/cores/arduino/USB" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/hardware/arduino/sam/variants/arduino_due_x" -I"C:/MATLAB/SupportPackages/R2015a/arduinodue/toolbox/realtime/targets/arduinodue/include" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/libraries/Servo/src" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.5.6-r2/libraries/Servo/src/sam" -c -g -Os -w -ffunction-sections -fdata-sections -nostdlib --param max-inline-insns-single=500 -fno-rtti -fno-exceptions -mcpu=cortex-m3 -mthumb -I. -D"MODEL=ADPATIVE1" -D"NUMST=2" -D"NCSTATES=7" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=1" -D"printf=iprintf" -D"F_CPU=84000000" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_ROTH_DUE_=" -D"ARDUINO=156" -D"ARDUINO_SAM_DUE=" -D"ARDUINO_ARCH_SAM=" -D"__SAM3X8E__=" -D"USB_PID=0x003e" -D"USB_VID=0x2341" -D"USBCON=" -D"_RTT_NUMSERVOS_=0" -D"_RTT_SINGLE_TASKING_MODE_="

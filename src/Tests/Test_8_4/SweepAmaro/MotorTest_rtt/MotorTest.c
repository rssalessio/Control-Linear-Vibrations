...
void MotorTest_output(void)
{
  ...
  uint32_T tmp;
  uint32_T tmp_0;
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    /* set solver stop time */
    rtsiSetSolverStopTime(&MotorTest_M->solverInfo,
                          ((MotorTest_M->Timing.clockTick0+1)*
      MotorTest_M->Timing.stepSize0));
  }                                    /* end MajorTimeStep */

  /* Update absolute time of base rate at minor time step */
  if (rtmIsMinorTimeStep(MotorTest_M)) {
    MotorTest_M->Timing.t[0] = rtsiGetT(&MotorTest_M->solverInfo);
  }
  ...
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    ...
    /* DataTypeConversion: '<S4>/conversion13' */
    MotorTest_B.conversion13 = 0.0F;

    /* DataTypeConversion: '<S4>/conversion2' */
    MotorTest_B.conversion2 = 0.0F;

    /* DiscretePulseGenerator: '<Root>/Pulse Generator' */
    rtb_PulseGenerator = (MotorTest_DW.clockTickCounter <
                          MotorTest_P.PulseGenerator_Duty) &&
      (MotorTest_DW.clockTickCounter >= 0) ? MotorTest_P.PulseGenerator_Amp :
      0.0;
    ...
    MotorTest_B.SFunction_d = MW_digitalRead(MotorTest_P.SFunction_p1);

    /* S-Function (sfcn_encoder): '<S6>/S-Function' */
    sfcn_encoder_Outputs_wrapper(&MotorTest_B.SFunction_d,
      &MotorTest_B.SFunction, &MotorTest_DW.SFunction_DSTATE,
      &MotorTest_P.SFunction_P1_h, 1, &MotorTest_P.Encoder_dt_enc, 1);

    /* Gain: '<S1>/Gain' */
    tmp = (uint32_T)MotorTest_P.Gain_Gain;
    tmp_0 = (uint32_T)MotorTest_B.SFunction;
    sMultiWordMul(&tmp, 1, &tmp_0, 1, &rtb_Gain.chunks[0U], 2);

    /* Sum: '<Root>/Add1' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Sum: '<Root>/Add'
     */
    MotorTest_B.Add1 = (MotorTest_P.Constant1_Value + rtb_PulseGenerator) -
      sMultiWord2Double(&rtb_Gain.chunks[0U], 2, 0) * 9.0949470177292824E-13;
  }

  /* DataTypeConversion: '<S8>/conversion8' incorporates:
   *  ZeroPole: '<Root>/Zero-Pole'
   */
  MotorTest_B.conversion8 = (real32_T)((MotorTest_P.ZeroPole_C[0] *
    MotorTest_X.ZeroPole_CSTATE[0] + MotorTest_P.ZeroPole_C[1] *
    MotorTest_X.ZeroPole_CSTATE[1]) + MotorTest_P.ZeroPole_D * MotorTest_B.Add1);
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    /* S-Function (arduinodigitalinput_sfcn): '<S7>/S-Function' */
    rtb_SFunction_0 = MW_digitalRead(MotorTest_P.SFunction_p1_l);

    /* Logic: '<S8>/Logical Operator' incorporates:
     *  S-Function (arduinodigitalinput_sfcn): '<S7>/S-Function'
     */
    MotorTest_B.LogicalOperator = (rtb_SFunction_0 && MotorTest_B.SFunction2_o1);
  }

  /* S-Function (sfcn_motor_new): '<S8>/S-Function1' */
  ...
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    /* DataTypeConversion: '<S4>/conversion4' incorporates:
     *  DataTypeConversion: '<S2>/Data Type Conversion1'
     */
    MotorTest_B.conversion4 = MotorTest_B.SFunction1_o1;

    /* DataTypeConversion: '<S4>/conversion5' incorporates:
     *  DataTypeConversion: '<S2>/Data Type Conversion1'
     */
    MotorTest_B.conversion5 = MotorTest_B.SFunction1_o1;

    /* DataTypeConversion: '<S4>/conversion6' */
    MotorTest_B.conversion6 = 0.0F;

    /* DataTypeConversion: '<S4>/conversion7' */
    MotorTest_B.conversion7 = sMultiWord2Single(&rtb_Gain.chunks[0U], 2, 0) *
      9.09494702E-13F;
    ...
    SerialTx_Outputs_wrapper(&MotorTest_B.SFunction2_o1, (boolean_T*)
      ...
      &MotorTest_B.conversion1, &MotorTest_B.conversion3,
      &MotorTest_B.conversion9, &MotorTest_B.conversion10,
      &MotorTest_B.conversion13, &MotorTest_B.conversion2,
      &MotorTest_B.conversion4, &MotorTest_B.conversion5,
...
void MotorTest_update(void)
{
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    ...
    signals_Update_wrapper( &MotorTest_B.SFunction2_o1,
      &MotorTest_B.SFunction2_o2, &MotorTest_DW.SFunction2_DSTATE);
  ...
  /* S-Function "sfcn_motor_new_wrapper" Block: <S8>/S-Function1 */
  ...
  if (rtmIsMajorTimeStep(MotorTest_M)) {
    rt_ertODEUpdateContinuousStates(&MotorTest_M->solverInfo);
  }
   ...
   */
  ++MotorTest_M->Timing.clockTick0;
  MotorTest_M->Timing.t[0] = rtsiGetSolverStopTime(&MotorTest_M->solverInfo);
...
void MotorTest_derivatives(void)
{
  XDot_MotorTest_T *_rtXdot;
  _rtXdot = ((XDot_MotorTest_T *) MotorTest_M->ModelData.derivs);

  /* Derivatives for ZeroPole: '<Root>/Zero-Pole' */
  _rtXdot->ZeroPole_CSTATE[0] = 0.0;
  _rtXdot->ZeroPole_CSTATE[1] = 0.0;
  _rtXdot->ZeroPole_CSTATE[0] += MotorTest_P.ZeroPole_A[0] *
    MotorTest_X.ZeroPole_CSTATE[0];
  _rtXdot->ZeroPole_CSTATE[1] += MotorTest_P.ZeroPole_A[1] *
    MotorTest_X.ZeroPole_CSTATE[0];
  _rtXdot->ZeroPole_CSTATE[0] += MotorTest_P.ZeroPole_B * MotorTest_B.Add1;

  /* Derivatives for TransferFcn: '<Root>/Transfer Fcn1' */
  _rtXdot->TransferFcn1_CSTATE = 0.0;
  _rtXdot->TransferFcn1_CSTATE += MotorTest_P.TransferFcn1_A *
    MotorTest_X.TransferFcn1_CSTATE;

  /* Derivatives for TransferFcn: '<Root>/Transfer Fcn' */
  _rtXdot->TransferFcn_CSTATE = 0.0;
  _rtXdot->TransferFcn_CSTATE += MotorTest_P.TransferFcn_A *
    MotorTest_X.TransferFcn_CSTATE;
}
...
void MotorTest_initialize(void)
{
...

  {
    ...
    rtsiSetdXPtr(&MotorTest_M->solverInfo, &MotorTest_M->ModelData.derivs);
    rtsiSetContStatesPtr(&MotorTest_M->solverInfo, (real_T **)
                         &MotorTest_M->ModelData.contStates);
    rtsiSetNumContStatesPtr(&MotorTest_M->solverInfo,
      &MotorTest_M->Sizes.numContStates);
    rtsiSetErrorStatusPtr(&MotorTest_M->solverInfo, (&rtmGetErrorStatus
      (MotorTest_M)));
    rtsiSetRTModelPtr(&MotorTest_M->solverInfo, MotorTest_M);
  }

  rtsiSetSimTimeStep(&MotorTest_M->solverInfo, MAJOR_TIME_STEP);
  MotorTest_M->ModelData.intgData.y = MotorTest_M->ModelData.odeY;
  MotorTest_M->ModelData.intgData.f[0] = MotorTest_M->ModelData.odeF[0];
  MotorTest_M->ModelData.intgData.f[1] = MotorTest_M->ModelData.odeF[1];
  MotorTest_M->ModelData.intgData.f[2] = MotorTest_M->ModelData.odeF[2];
  MotorTest_M->ModelData.contStates = ((X_MotorTest_T *) &MotorTest_X);
  rtsiSetSolverData(&MotorTest_M->solverInfo, (void *)
                    &MotorTest_M->ModelData.intgData);
  rtsiSetSolverName(&MotorTest_M->solverInfo,"ode3");
  rtmSetTPtr(MotorTest_M, &MotorTest_M->Timing.tArray[0]);
  MotorTest_M->Timing.stepSize0 = 0.005;
  ...
  /* states (continuous) */
  {
    (void) memset((void *)&MotorTest_X, 0,
                  sizeof(X_MotorTest_T));
  }
  ...
  MW_pinModeInput(MotorTest_P.SFunction_p1);
  ...
  MotorTest_X.ZeroPole_CSTATE[0] = 0.0;
  MotorTest_X.ZeroPole_CSTATE[1] = 0.0;
  ...
  MotorTest_X.TransferFcn1_CSTATE = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/Transfer Fcn' */
  MotorTest_X.TransferFcn_CSTATE = 0.0;

...
In any case the Arduino Due cannot reliably measure more than 5 \SI{}{\ampere} current as the data-sheet specifies, so from this point onward we will limit all test currents to 5 \SI{}{\ampere} in both directions. Even in this way a difference remains between positive and negative measured current.  
  \begin{figure}[!tbh]
  	\centering
  	\subfloat[Negative maximum current]{\includegraphics[width=0.5\textwidth]{img/neg_max_current.jpg}}
  	\hfill
  	\subfloat[Positive maximum current]{\includegraphics[width=0.5\textwidth]{img/pos_max_current.jpg}}
...
All these experiment were done in order to estimate the variance of the current sensor and to have enough information to build the variance matrixes for the Kalman filter.
  \begin{figure}[!tbh]
  	\centering
  	\subfloat[]{\includegraphics[width=0.5\textwidth]{img/neg_ladder.jpg}}
  	\hfill
  	\subfloat[ ]{\includegraphics[width=0.5\textwidth]{img/pos_ladder.jpg}}
  	\caption{Ladder signal used for variance identification}
 
  \end{figure}
  \begin{figure}[h]
  	\centering
  	\includegraphics[width=0.5\textwidth]{img/current_variance_estimated.png}
  	\caption{Estimated noise variance of the sensor}
  \end{figure}

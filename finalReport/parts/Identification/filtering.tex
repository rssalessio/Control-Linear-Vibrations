...
\begin{figure}[!tbh]
  \centering
  \subfloat[$K$ estimation by feeding a train of pulses to the openloop plant.]{\includegraphics[width=0.5\textwidth]{img/ekf_sim}}
  \hfill
  \subfloat[Online estimation by feeding a train of pulses to the openloop plant.]{\includegraphics[width=0.5\textwidth]{img/ekf_ard}}
  \caption{}
    \label{fig:ekfsimard}
\end{figure}

...
In figure is shown the plot of the current and its estimate. In figure the plot of the cart position.
    \begin{figure}[!tbh]
  \centering
  \subfloat[Plot of $g(v),v$.]{\includegraphics[width=0.5\textwidth]{img/static_fric_1.png}}
  \hfill
  \subfloat[Identified model vs real current.]{\includegraphics[width=0.5\textwidth]{img/static_fric_2.png}}
  \caption{}
     \label{fig:sfric}
\end{figure}